...
**Next:** [Configure Environment]({{< relref "5-configure-agent-environment" >}}) — personalize Splunk Agent Observability settings and verify LLM and MCP connectivity before Part 1.
